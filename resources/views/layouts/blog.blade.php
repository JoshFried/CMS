        ...
        <div class="container">
            ...
            <div class="navbar-left">
                ...
                <a class="navbar-brand" href="{{ route('welcome') }}">
                    ...
                    <img class="logo-light" src="{{ asset('img/joshcancode.png') }}" alt="logo" width="30%" style="border radius:50%">
                </a>
            </div>
...
@yield('content')
        ...
        <div class="container">
            <div class="row gap-y align-items-center">
                ...
                <div class="col-6 col-lg-3">
                    <a href="/"><img src="{{ asset('img/joshcancode.png') }}" width="70%" alt="logo"></a>
                </div>
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5d323d6e25937748"></script>
